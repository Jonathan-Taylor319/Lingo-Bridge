...
export async function signup(context) {
    ...
    const { body, status, statusText } = await basicFetch("http://3.149.23.222:8000/user/signup/", payload);
...
export async function login(context) {
    ...
    const { body, status, statusText } = await basicFetch("http://3.149.23.222:8000/user/get-token/", payload);
